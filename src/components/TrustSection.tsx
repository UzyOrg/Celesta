      ...
      <Container>
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className={`${textStyles.largeBody} ${opacityVariants.secondary} mt-4 max-w-3xl mx-auto`}>
            We partner with innovative institutions and forward-thinking companies to shape the future of education and professional development through responsible AI.
          </p>
        </div>
