  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-neutral-950 via-neutral-900 to-neutral-950">
      <div className="max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="bg-gradient-to-br from-turquoise/5 to-transparent rounded-xl p-6 border border-turquoise/20 mb-12">
          <div className="flex items-center gap-3 mb-4">
            <div className="p-2 rounded-lg bg-turquoise/20">
              <Brain className="w-5 h-5 text-turquoise" />
            </div>
            <h3 className="text-lg font-semibold text-neutral-100">Próximamente en tu Biblioteca</h3>
          </div>
